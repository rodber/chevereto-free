...
class Search
{
    ...
    public function build()
    {
        ...
        if ($this->requester['is_content_manager']) {
        ...
        $search_op = $this->handleSearchOperators($this->q, $this->requester['is_content_manager'] == true);
        ...
        switch ($this->type) {
            case 'images':
                ...
                if (is_array($search_op_wheres) && count($search_op_wheres) > 0) {
