                    ...
                    <div class="c9 phablet-c1">
                        ...
                        <?php
                            ...
                            <div class="input-label">
                                ...
                                <input type="email" name="email" id="email" class="text-input" value="<?php echo get_safe_post() ? get_safe_post()["email"] : get_user()["email"]; ?>" placeholder="<?php _se('Your email address'); ?>" <?php if (is_email_required()) {
                                    ?> required<?php
                                } ?>>
                    ...
                    <?php
                        ...
                        <div class="c9 phablet-c1">
                            ...
                            <div class="input-label input-password">
                                ...
                                <span class="text-align-right input-warning input-below red-warning<?php echo get_input_errors()["new-password-confirm"] ? "" : " hidden-visibility"; ?>" data-text="<?php _se("Passwords don't match"); ?>"><?php if (get_input_errors()["new-password-confirm"]) {
                ...
                <?php if (is_settings_profile()) {
                    ...
                    <div class="c19 phablet-c1">
                        ...
                        ?>
                                ...
                                <span class="user-image default-user-image<?php echo(get_user()["avatar"]["url"] ? ' hidden' : ''); ?>"><span class="icon icon-user2"></span></span>
                    ...
                    <?php
                        if (!is_dashboard_user()) {
                            foreach (get_available_connections() as $connection => $label) {
                                ?>
                            <div class="account-link input-label<?php if (get_connections()[$connection]) {
                                    echo ' soft-hidden';
