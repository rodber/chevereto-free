...
<?php
    if (get_user()["background"] or is_owner() or is_content_manager()) {
        ?>
<div id="background-cover" data-content="user-background-cover"<?php if (!get_user()["background"]) {
            ?> class="no-background"<?php
        } ?>>
	<div id="background-cover-wrap">
		<div id="background-cover-src" data-content="user-background-cover-src"<?php if (get_user()["background"]["url"]) {
	...
	<div class="content-width">
		<?php
            if (is_owner() or is_content_manager()) {
                ?>
		<span data-content="user-upload-background" class="btn btn-input default<?php if (get_user()["background"]) {
                    ?> hidden<?php
                } ?>" data-trigger="user-background-upload"><?php _se('Upload profile background'); ?></span>
		<div id="change-background-cover" data-content="user-change-background" class="pop-btn<?php if (!get_user()["background"]) {
                    ?> hidden<?php
                } ?>">
...
<div class="content-width">
	...
	<div id="top-user" class="top-user<?php echo (!get_user()["background"] and (!is_owner() and !is_content_manager())) ? ' user-has-no-background' : null; ?>">
		<div class="top-user-credentials">
			...
			<div class="user-meta"><span class="user-social-networks"><?php if (get_user()["twitter"]) {
                    ?><a class="icon-twitter" href="<?php echo get_user()["twitter"]["url"]; ?>" rel="nofollow" target="_blank"></a><?php
                } if (get_user()["facebook"]) {
                    ?><a class="icon-facebook" href="<?php echo get_user()["facebook"]["url"]; ?>" rel="nofollow" target="_blank"></a><?php
                } if (get_user()["website"]) {
                    ?><a class="icon-globe" href="<?php echo get_user()['website_display']; ?>"<?php echo !get_user()['is_admin'] ? ' rel="nofollow"' : null; ?> target="_blank"></a><?php
                } ?></span><?php
