...
<div class="content-width">
	...
	<div class="header header-content margin-bottom-10">
			...
			<div class="header-content-breadcrum">
                ...
                if (get_album()['user']['id']) {
					...
					<div class="breadcrum-item">
						...
						<span class="breadcrum-text float-left"><span class="user-link"><?php echo get_album()['user']['is_private'] ? _s('Private') : _s('Guest'); ?><span class="arrow arrow-right"></span></span></span>
					</div>
				<?php
                }
                ?>
				...
				<div class="breadcrum-item">
					<h1><span class="breadcrum-text"><span class="icon icon-eye-blocked margin-right-5 <?php if (get_album()["privacy"] == "public") {
                    echo "soft-hidden";
                } ?>" data-content="privacy-private" title="<?php _se('This content is private'); ?>" rel="tooltip"></span><span class="breadcrum-text"><a href="<?php echo get_album()["url"]; ?>" data-text="album-name" <?php if (get_album()['name'] !== get_album()['name_truncated']) {
                    ?> title="<?php echo get_album()["name_html"]; ?><?php
                } ?>"><?php echo get_album()["name_truncated_html"]; ?></a></span></h1>
				</div>
				<?php
		...
		<div class="header-content-right phone-hide">
			...
			<?php
            if (is_owner()) {
                if (CHV\getSetting('upload_gui') == 'js') {
				...
				<<?php echo $createAlbumTag; ?> class="btn default" <?php echo $createAlbumAttr; ?>><span class="btn-icon icon-cloud-upload"></span><span class="btn-text phone-hide"><?php _se('Upload to album'); ?></span></<?php echo $createAlbumTag; ?>>
			<?php
            }
            ?>
		</div>
	...
	<div id="content-listing-tabs" class="tabbed-listing">
		...
		<div id="tabbed-content-group">
			...
			<div id="tab-share" class="tabbed-content margin-top-30">
				...
				<div class="growl static text-align-center margin-bottom-30 clear-both<?php if (get_album()["privacy"] == "public") {
                echo " soft-hidden";
            } ?>" data-content="privacy-private"><?php echo get_album()['privacy_notes']; ?></div>
