...
<div id="maintenance-cover" style="background-image: url(<?php echo CHV\get_system_image_url(CHV\getSetting('maintenance_image')); ?>);">
	<div id="maintenance-cover-inner">
		<div id="maintenance-cover-content" class="c16 center-box">
			<a href="<?php echo G\get_base_url(); ?>" id="logo"><img class="replace-svg" src="<?php echo CHV\get_system_image_url(CHV\getSetting(CHV\getSetting('logo_vector_enable') ? 'logo_vector' : 'logo_image')); ?>" alt="<?php echo get_safe_html_website_name(); ?>"></a>
