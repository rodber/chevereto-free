...
<div id="image-viewer" class="image-viewer full-viewer margin-bottom-10">
    ...
    <div id="image-viewer-container" class="image-viewer-main image-viewer-container">
        ...
        ?> class="no-select" <?php
    } ?> alt="<?php echo get_image()['alt']; ?>" width="<?php echo get_image()['width']; ?>" height="<?php echo get_image()['height']; ?>" <?php if (get_image()['medium']) {
        ?> data-load="full" <?php
    } ?>>
        <?php if (get_image()['is_use_loader']) {
        ?>
        <div id="image-viewer-loader" data-size="<?php echo get_image()['size']; ?>"><?php if (get_image()['is_animated']) {
            ?><span class="btn-icon icon icon-play3"></span><?php
        } ?><span class="btn-text"><?php get_image()['is_animated'] ? _se('Play GIF') : _se('Load full resolution'); ?> - <?php echo get_image()['size_formatted']; ?></span></div>
    <?php
    } ?>
    </div>
    <?php
...
<div class="content-width">
    ...
    <div class="header header-content margin-bottom-10">
        <div class="header-content-left">
            <div class="header-content-breadcrum">
                ...
                ?>
                <div class="breadcrum-item">
                    <span class="breadcrum-text"><span class="icon icon-eye-blocked margin-right-5 <?php if (!get_image()['album'] or get_image()['album']['privacy'] == 'public') {
                    echo 'soft-hidden';
    ...
    <div class="header">
        ...
        ?><div class="number-figures float-left"><span class="icon icon-heart4"></span> <b data-text="likes-count"><?php echo get_image()['likes']; ?></b></div><?php
    } ?>
        </div>
    </div>
    ...
    <div id="tabbed-content-group">
        ...
        <div id="tab-about" class="tabbed-content<?php echo get_current_tab() == 'about' ? ' visible' : null; ?>">
            <div class="c9 phablet-c1 fluid-column grid-columns">
                <div class="panel-description default-margin-bottom">
                    ...
                    <p class="description-meta margin-bottom-5">
                        ...
                        if (get_image()['album']['id'] and (get_image()['album']['privacy'] !== 'private_but_link' or is_owner() or is_content_manager())) {
            ...
            <?php
            if (get_image()['album'] && get_image_album_slice()['images']) {
                ?>
                <div class="c15 phablet-c1 fluid-column grid-columns margin-left-10 phablet-margin-left-0 phone-margin-left-0">
                    <h4 class="title c4 phablet-c1 grid-columns"><span data-content="album-panel-title" <?php if (get_image()['album']['id'] == null) {
                    echo ' class="soft-hidden"';
                } ?>><?php _se('In this album'); ?></span></h4>
